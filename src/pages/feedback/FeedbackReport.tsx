...
const reports = [
  { label: "Feedback Report 2017–18", href: "http://snbpacsms.com/WebsitePages/PDF/Feedback/FeedbackReport1718.pdf", color: "border-t-blue-500",   badge: "bg-blue-100 text-blue-700 border-blue-200",       btn: "bg-blue-500 hover:bg-blue-600 text-white" },
  { label: "Feedback Report 2018–19", href: "http://snbpacsms.com/WebsitePages/PDF/Feedback/FeedbackReport1819.pdf", color: "border-t-indigo-600", badge: "bg-indigo-100 text-indigo-700 border-indigo-200",   btn: "bg-indigo-600 hover:bg-indigo-700 text-white" },
  { label: "Feedback Report 2019–20", href: "http://snbpacsms.com/WebsitePages/PDF/Feedback/FeedbackReport1920.pdf", color: "border-t-emerald-500", badge: "bg-emerald-100 text-emerald-700 border-emerald-200", btn: "bg-emerald-500 hover:bg-emerald-600 text-white" },
  { label: "Feedback Report 2020–21", href: "http://snbpacsms.com/WebsitePages/PDF/Feedback/FeedbackReport2021.pdf", color: "border-t-orange-500", badge: "bg-orange-100 text-orange-700 border-orange-200",   btn: "bg-orange-500 hover:bg-orange-600 text-white" },
  { label: "Feedback Report 2021–22", href: "http://snbpacsms.com/WebsitePages/PDF/Feedback/FeedbackReport2122.pdf", color: "border-t-red-500",    badge: "bg-red-100 text-red-700 border-red-200",           btn: "bg-red-500 hover:bg-red-600 text-white" },
];
