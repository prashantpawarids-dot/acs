...
/* ── Content parser: bullets → flowing prose ── */
        ...
        <div className="container max-w-3xl mx-auto px-4">
          ...
          >
            <div className="relative flex items-center justify-center">
              ...
              />
              <div className="relative z-10 w-16 h-16 rounded-2xl bg-primary flex items-center justify-center shadow-xl">
