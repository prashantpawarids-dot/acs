...
const data = aboutData["objectives"];
        ...
        <div className="container max-w-3xl mx-auto px-4">
          ...
          >
            <div className="relative flex items-center justify-center">
              <span
                className="absolute w-20 h-20 rounded-full bg-orange-400/20"
                style={{ animation: "ping-slow 2.5s ease-in-out infinite" }}
              />
              <div className="relative z-10 w-16 h-16 rounded-2xl bg-orange-500 flex items-center justify-center shadow-xl">
          ...
          >
            {/* Top accent bar */}
            <div className="h-1.5 w-full bg-gradient-to-r from-orange-500 via-orange-300 to-transparent" />
              ...
              {blocks.map((b, i) => {
                  ...
                  return (
                    <Reveal key={i} from="left" delay={i * 80}>
                      <h2 className="text-xl font-bold text-foreground mt-2 mb-1 flex items-center gap-2">
                        <span className="w-1 h-6 rounded-full bg-orange-500 inline-block flex-shrink-0" />
                        {b.plain}
                      </h2>
                    </Reveal>
                  );
                ...
                return (
                  <Reveal key={i} from={i % 2 === 0 ? "left" : "right"} delay={i * 80}>
                    <div className="mb-3">
                      {b.headingLine && (
                        <p className="text-sm font-bold text-orange-600 uppercase tracking-wide mb-1">
                          {b.headingLine}
                        </p>
                      )}
                      {b.prose ? (
