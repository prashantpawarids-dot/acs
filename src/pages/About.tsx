...
{isOrganogramPage && pageAboutData.pdf && (
  <div className="mb-6 flex justify-center">
    <div
      className="w-52 text-center cursor-pointer transition-all duration-300 hover:-translate-y-3 hover:shadow-2xl border border-border rounded-2xl border-t-4 border-t-red-500 p-5 flex flex-col items-center gap-3 bg-card"
      onClick={() => window.open(pageAboutData.pdf!, "_blank")}
    >
      <img
      ...
      />
      <Button size="sm" className="rounded-full gap-2 w-full bg-red-500 hover:bg-red-600 text-white">
